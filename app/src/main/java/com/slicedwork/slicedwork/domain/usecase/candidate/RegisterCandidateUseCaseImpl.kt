...
class RegisterCandidateUseCaseImpl @Inject constructor(private val candidateRepository: CandidateRepository): RegisterCandidateUseCase {
    override suspend fun invoke(candidate: Candidate) {
