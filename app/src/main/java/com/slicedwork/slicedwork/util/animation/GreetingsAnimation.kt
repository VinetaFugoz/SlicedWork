    ...
    private fun partOne(binding: FragmentGreetingsBinding): AnimatorSet {
        ...
        partOne.run {
            playTogether(
                ...
                fade(binding.tvDescription, 0, 1f, 0f),
                fade(binding.btnSignIn, 0, 1f, 0f),
                fade(binding.btnSignUp, 0, 1f, 0f),
    ...
    private fun partEight(binding: FragmentGreetingsBinding): AnimatorSet {
        ...
        partSeven.run {
            playTogether(
                ...
                fade(binding.tvDescription, 500, 0f, 1f),
                fade(binding.btnSignIn, 500, 0f, 1f),
                fade(binding.btnSignUp, 500, 0f, 1f),
            )
        }
